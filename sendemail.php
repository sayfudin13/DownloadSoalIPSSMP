...
$query = mysqli_query($link, "SELECT * FROM data where username = '".$username."' and status = 0");
...
if ($row > 0) {
  ...
  $mail->Subject = "Permintaan Registrasi";
  $body = '
            ...
            <table border="0" cellpadding="30" cellspacing="0" width="500" class="flexibleContainer">
              <tr>
                <td style="padding-top:0;" align="center" valign="top" width="500" class="flexibleContainerCell">
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="50%" class="" style="">
                    <tr>
                      <td align="center" valign="middle" class="" style="padding-top:15px;padding-bottom:5px;padding-right:15px;padding-left:15px;">
                        <span style="font-family:Helvetica,Arial,sans-serif;font-size:20px;line-height:135%;">or</span>
                      </td>
                    </tr>
                  </table>
                  <table border="0" cellpadding="0" cellspacing="0" width="100%" class="" style="">
                    <tr>
                      <td align="center" valign="middle" class="" style="padding-top:5px;padding-bottom:15px;padding-right:15px;padding-left:15px;">
                        <a style="font-family:Helvetica,Arial,sans-serif;font-size:12px;line-height:135%;" href="#" target="_blank">https://cpanel.idhostinger.com/hosting/index/aid/21176725</a>
                      </td>
                    </tr>
                  </table>
                  <!-- // CONTENT TABLE -->
                    ...
                    <tr>
                      <td align="center" valign="top">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                          <tr>
                            <td valign="top" class="textContent">
                              <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color:#5F5F5F;line-height:135%;">Copyright &#169; 2016 <a href="http://www.mytempweb.tk/" target="_blank" style="text-decoration:none;color:#828282;"><span style="color:#828282;">DownloadSoalIPSSMP</span></a>. All&nbsp;rights&nbsp;reserved.</div>
                            </td>
                          </tr>
                        </table>
                        <!-- // CONTENT TABLE -->
  ...
  $mail->AddAddress("web-67kQSY@mail-tester.com");
  //attachment Foto
